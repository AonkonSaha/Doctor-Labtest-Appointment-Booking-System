...
public final class ApiPaths {
    ...
    public static final class Doctor {
        ...
        public static final String FETCH_BY_ID = ROOT + "/fetch/{id}";
        public static final String FETCH_ALL = ROOT + "/fetch/all";
        public static final String FETCH = ROOT + "/fetch";
    ...
    public static final class DoctorBooking {
        ...
        public static final String UPDATE = ROOT + "/update/{id}";
        public static final String DELETE = ROOT + "/delete/{id}";
        public static final String TIME_SLOT = ROOT + "/fetch/time/slot";
        public static final String HISTORY = ROOT + "/fetch/all/history";
    }
