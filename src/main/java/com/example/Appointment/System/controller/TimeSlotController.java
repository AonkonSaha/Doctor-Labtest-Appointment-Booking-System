...
import static com.example.Appointment.System.constant.ApiPaths.TimeSlot;

@RestController
@RequestMapping(TimeSlot.ROOT)
@RequiredArgsConstructor
@SecurityRequirement(name = "bearerAuth")
public class TimeSlotController {
    private final TimeSlotService timeSlotService;

    @PostMapping(TimeSlot.REGISTER)
